...
using AdsTest.Sessions;
using AdsTest.Web.Controllers.Results;
using AdsTest.Web.Models;
using AdsTest.Web.Models.Account;
...
{
    public class AccountController : AdsTestControllerBase
    {
